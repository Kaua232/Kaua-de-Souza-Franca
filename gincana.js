...
cidade.trim()
cidade.toLowerCase()
console.log(cidade.includes('paulo')) //Pois a variável cidade tem 'sao paulo' atrubuído, e ela contem 'paulo'
//Pois Neste mesmo dia é celebrado pela igreja católica o dia da conversão do apóstolo Paulo, o que deu origem ao nome da cidade.
...
console.log(`idade atual: ${2024 - anoNascimento}`)
console.log(`maior que 18: ${(2024 - anoNascimento) > 18}`)
...
const salario = 2000
console.log(`Salario com descontos: ${salario - 500}`)
console.log(`Salario final maior que 1500: ${salario > 1500}`)
