...
function cadastrarDoador(){
    ...
    tipoSanguineo = ask.question('Por favor, insira o tipo sanguineo do doador: ').toLowerCase()
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`)
    ...
    let auxiliar1 = ask.question('Digite o tipo de sangue que voce deseja procurar: ').toLowerCase()
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⠿⠿⠿⠿⠿⠿⠿⠿⠿⠇`)
    ...
    for (const c of doadores) {
        if(auxiliar2 < 1|| auxiliar2 > 31){
            console.log('dia invalido')
        }if(auxiliar3 < 1 || auxiliar3 > 12){
            console.log('mes invalido')    
        }else if(auxiliar4 > 2024){
            console.log('ano invalido')
